...
/*
 * 현재 클래스가 위치하는 패키지와 하위패키지의 클래스를 모두스캔해서
 * @Annotation 을 스캔해서 초기화(객체생성,의존성주입)
 * 
 */
...
public class SpringBootBeanCreateApplicationMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("--------------빈의 아이디로 Spring container에 등록되어있는 스프링빈 참조얻기------------");
		...
		System.out.println("--------------빈의 클래스로 Spring container에 등록되어있는 스프링빈 참조얻기------------");
